...
import { useGetIndividualChannel } from "@/features/channels/api/use-get-individual-channel";
...
const ChannelIdPage = () => {
    ...
    const {data: channel, isLoading: channelLoading} = useGetIndividualChannel({id: channelId});
